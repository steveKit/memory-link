...
interface EventDao {
     ...
     * Used to display today's events.
     * 
     ...
     * Used to determine what to display in AWAKE_WITH_EVENT state.
     * 
    ...
    /**
     * Get all config events for processing.
     * Config events are parsed for settings (SLEEP, WAKE, BRIGHTNESS, etc.)
     */
    @Query("""
        SELECT * FROM cached_events 
    ...
    /**
     * Insert or update events (upsert).
    ...
    /**
     * Delete events older than the specified cutoff.
     * Per .clinerules: Delete events older than 7 days on each sync.
     * 
    ...
    /**
     * Delete all events.
     * Used for testing or full cache clear.
     */
